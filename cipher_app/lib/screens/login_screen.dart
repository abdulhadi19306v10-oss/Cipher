                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('We\'re so excited to see you again!', style: TextStyle(color: Colors.white.withOpacity(0.6))),
                        ...
                        TextButton(
                          ...
                          child: const Text('Need an account? Register', style: TextStyle(color: Color(0xFF00A884), fontWeight: FontWeight.bold)),
                        )
                      ],
                    ),
                  ),
